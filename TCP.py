            ...
            while True:
                ...
                if data2.hex().startswith('0500') and len(data2.hex()) > 1000:
                    try:
                        ...
                        message = f'[B][C]{get_random_color()}\n- Welcome To Emote Bot ! \n\n{get_random_color()}- Commands : /emote {xMsGFixinG('123456789')} {xMsGFixinG('909000001')}\n\n[00FF00]Dev : @{xMsGFixinG('Auraxseller')}'
...
async def MaiiiinE():
    Uid , Pw = '4166987379' , '3EC126F2476BCF8FA29EF4633B2303F27BCFB6DE5FC930551C6072D28F1A6D65'
    ...
    os.system('clear')
    print(render('KANHA', colors=['white', 'green'], align='center'))
    print('')
